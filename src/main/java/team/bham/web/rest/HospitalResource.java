...
/**
 * REST controller for managing {@link team.bham.domain.Hospital}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class HospitalResource {
    ...
    public ResponseEntity<Hospital> partialUpdateHospital(
        ...
        Optional<Hospital> result = hospitalRepository
            ...
            .map(existingHospital -> {
                ...
                if (hospital.getHospitalLocation() != null) {
                    existingHospital.setHospitalLocation(hospital.getHospitalLocation());
                }

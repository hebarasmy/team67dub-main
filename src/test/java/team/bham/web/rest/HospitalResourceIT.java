...
import team.bham.repository.HospitalRepository;
...
class HospitalResourceIT {
    ...
    private static final Geopoint DEFAULT_HOSPITAL_LOCATION = Geopoint.LATITUDE;
    private static final Geopoint UPDATED_HOSPITAL_LOCATION = Geopoint.LONGITUDE;
    ...
    public static Hospital createEntity(EntityManager em) {
        Hospital hospital = new Hospital().hospitalName(DEFAULT_HOSPITAL_NAME).hospitalLocation(DEFAULT_HOSPITAL_LOCATION);
        return hospital;
    }
    ...
    public static Hospital createUpdatedEntity(EntityManager em) {
        Hospital hospital = new Hospital().hospitalName(UPDATED_HOSPITAL_NAME).hospitalLocation(UPDATED_HOSPITAL_LOCATION);
        return hospital;
    }
    ...
    void createHospital() throws Exception {
        ...
        assertThat(testHospital.getHospitalLocation()).isEqualTo(DEFAULT_HOSPITAL_LOCATION);
    }
    ...
    void getAllHospitals() throws Exception {
        ...
        restHospitalMockMvc
            ...
            .andExpect(jsonPath("$.[*].hospitalLocation").value(hasItem(DEFAULT_HOSPITAL_LOCATION.toString())));
    }
    ...
    void getHospital() throws Exception {
        ...
        restHospitalMockMvc
            ...
            .andExpect(jsonPath("$.hospitalLocation").value(DEFAULT_HOSPITAL_LOCATION.toString()));
    }
    ...
    void putExistingHospital() throws Exception {
        ...
        updatedHospital.hospitalName(UPDATED_HOSPITAL_NAME).hospitalLocation(UPDATED_HOSPITAL_LOCATION);
        ...
        assertThat(testHospital.getHospitalLocation()).isEqualTo(UPDATED_HOSPITAL_LOCATION);
    }
    ...
    void fullUpdateHospitalWithPatch() throws Exception {
        ...
        partialUpdatedHospital.hospitalName(UPDATED_HOSPITAL_NAME).hospitalLocation(UPDATED_HOSPITAL_LOCATION);
